...
export default function PrivacyPolicy() {
  return (
    <div className="container pt-20 mx-auto max-w-5xl px-4 py-12">
      <div className="rounded-xl bg-white p-6  md:p-10">
        <h1 className="mb-4 text-3xl font-bold text-[#3D568F] md:text-4xl">
          Privacy Policy
        </h1>
        <p className="mb-6 text-gray-500">Last updated: February 26, 2025</p>
        ...
        <div className="prose prose-lg max-w-none text-gray-700">
          ...
          <h2 className="mb-4 mt-8 text-2xl font-semibold text-[#3D568F]">
            Interpretation and Definitions
          </h2>

          <h3 className="mb-2 mt-6 text-xl font-semibold text-[#3D568F]">
            Interpretation
          </h3>
          <p>
          ...
          <ul className="my-4 list-disc space-y-2 pl-6">
            ...
            <li>
              <p>
                <strong>Application</strong> refers to Distance Connect, the
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to SKILLZIA EDUCATION TECHNOLOGIES
                PRIVATE LIMITED, C/o UmedSinghRana Vill &, PO Shahbad Daulatpur
                City, Shahbad Daulatpur, North West Delhi- 110042.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Distance Connect, accessible
                from{" "}
                <a
                  href="https://www.distanceconnect.in"
                  rel="external nofollow noopener"
                  target="_blank"
                  className="text-blue-600 hover:underline"
                >
                  www.distanceconnect.in
                </a>
              </p>
            </li>
            <li>
          ...
          <h4 className="mb-2 mt-4 text-lg font-semibold text-[#3D568F]">
            Personal Data
          </h4>
          <p>
          ...
          <ul className="my-4 list-none space-y-4 pl-6">
            <li>
              <p>
            ...
            <li>
              <p>
                ...
                <a
                  ...
                  className="text-blue-600 hover:underline"
                >
                  www.distanceconnect.in/contact
                </a>
              </p>
            </li>
            <li>
