...
const Faq = () => {
  ...
  <AccordionItem value="item-1">
    <AccordionTrigger className='w-[336px] h-[99px] flex-shrink-0 rounded-[15px] border border-[#D4D2E3] bg-white text-[#3D568F] font-inter text-[18px] font-bold leading-[24px] '>Is it accessible?
  ...
  <AccordionItem value="item-5">
    ...
    <AccordionItem value="item-1" className='flex flex-col justify-center items-center'>
        <AccordionTrigger className='flex w-full p-[20px_20px_20px_24px] flex-col items-start gap-2.5 rounded-[6px] border border-[#E1E4ED] bg-white shadow-[0px_0.5px_2px_0px_rgba(25,33,61,0.10)] text-[#3D568F] text-right font-inter text-[16px] font-semibold leading-[22px] '>Is it accessible?
        </AccordionTrigger>
